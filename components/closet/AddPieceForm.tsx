...
// Single-piece capture flow: photo → Claude drafts the details → editable
// confirm form → save, then straight back to capture for the next piece
// (cataloguing 30 items in one sitting is the bar).
//
// Chrome-free so it can render both as the /add-item page body and as one
// branch of AddToClosetModal; `onBack` is only rendered when supplied.

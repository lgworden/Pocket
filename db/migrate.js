...
async function main() {
  ...
  const migrations = [
    ...
    path.join(__dirname, "016_add_username.sql"),
    path.join(__dirname, "017_add_feed_comments.sql"),
    ...
    path.join(__dirname, "022_add_password_auth.sql"),
    ...
    path.join(__dirname, "027_add_moment_posts.sql"),
    path.join(__dirname, "028_add_feedback.sql"),
    path.join(__dirname, "029_add_outfit_log_favorite.sql"),
  ];
